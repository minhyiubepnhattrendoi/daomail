...
def fakeEmail():
  ...
  if chon == '2':
    ...
    for fake in range(so_luong):
      ...
      print (" [" + str(n) + "] => |sách 28|     " + fake_email)
...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m=> |\033[1;37msách 28\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m=> |\033[1;37msách 28\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      ...
      print(" \033[1;31m=> |\033[1;37msách 28\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def logo():
  logo = """    
             ...
             ╚══════╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚══════╝ ╚════╝ 
                  ...
                  \033[1;31m=> nhiều tool miễn phí cho mọi người
